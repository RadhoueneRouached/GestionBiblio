...
<c:import url="/WEB-INF/jspf/header.jsp">
		...
		<div id="center">
			...
			<div id="content">
				...
				<br /> <br /> <b>${message}</b> 
				<p>
					<form action="${pageContext.request.contextPath}/newEmprunt" >
						...
						<table border="1">
							...
							<c:forEach items="${emprunts}" var="emprunt">
								<tr>
									...
									<td><a
										href="${pageContext.request.contextPath}/editEmprunt/${emprunt.id_emp}"><fmt:message
												key='modify' /></a></td>
									<td><a
										href="${pageContext.request.contextPath}/deleteEmprunt/${emprunt.id_emp}"><fmt:message
												key='delete' /></a></td>
