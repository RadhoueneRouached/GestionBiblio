...
<c:import url="/WEB-INF/jspf/header.jsp">
		...
		<div id="center">
			...
			<!-- CONTENU  -->
			<div id="content">
				<form id="formID" class="formular" action="${pageContext.request.contextPath}/new" modelAttribute="adherent"  modelAttribute="adresse"
					method="post">
					<fieldset>
						<legend>
						...
						<label> <span><fmt:message key='lastName' /></span> <input
							...
							<input
							class="validate[required,custom[noSpecialCaracters],length[1,20]]"
							type="hidden" value="1" name="admin" id="id_admin_FK" />
						...
						<label> <span><fmt:message key='roadNumber' /></span> <input
							class="validate[required,custom[onlyNumber],length[1,20]]"
