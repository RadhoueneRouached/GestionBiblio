		...
		<div id="center">
			...
			<div id="content">
				<h2><fmt:message key='statistic' /></h2>
						...
						<h4> <fmt:message key='numberOfBorrows' /> : ${empruntTotal}</h4>
						<h4> <fmt:message key='numberOfDocuments' /> : ${documentTotal}</h4>
						<h4> <fmt:message key='numberOfMembers' /> : ${adherentTotal}</h4>
...
<div id="container">
  ...
  <table id="chartData">
	...
	<c:forEach items="${emprunts}" var="element"> 
