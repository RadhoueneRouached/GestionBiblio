...
<body>
		...
		<!-- 
				<c:choose>
					...
					<c:otherwise>
					<a href="?lang=en" class="type1">English</a>
						<a href="?lang=fr" class="type1">Francais</a>
					</c:otherwise>
				</c:choose>
					 <fmt:setLocale value="${sessionScope['lang']}"/>
			-->		 
<center id="message">${message }</center>
	<form id="formID" class="formular" action="${pageContext.request.contextPath}/verifConnexion" 
		method="post">
		<fieldset>
			...
			<label>
			<a href="${pageContext.request.contextPath}/inscription" alt=""><fmt:message key='signUp' /></a>			 
			</label>
